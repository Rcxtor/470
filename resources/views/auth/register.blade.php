<x-app-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="interger" name="phone" :value="old('phone')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="division" class="block mt-1 w-full" type="text" name="division" :value="old('division')" required autocomplete="username" />
